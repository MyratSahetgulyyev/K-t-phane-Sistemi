...
namespace Kutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> ENCOKYAZAN()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("ENCOKYAZAN");
        }
        ...
        public virtual ObjectResult<ENIYIYAYIN_Result> ENIYIYAYIN()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ENIYIYAYIN_Result>("ENIYIYAYIN");
        }
    
        public virtual ObjectResult<enyayin1_Result> enyayin1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<enyayin1_Result>("enyayin1");
        }
    }
}
